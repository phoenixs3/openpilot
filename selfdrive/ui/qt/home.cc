...
OffroadHome::OffroadHome(QWidget* parent) : QFrame(parent) {
  ...
  QLabel* version = new QLabel(QString::fromStdString(brand + " v0.8.4 Smart Roadster" ));
  ...
  andarna_img = QImage("../assets/images/andarna_background.png").scaled(1600, 914, Qt::KeepAspectRatio, Qt::SmoothTransformation);
...
void OffroadHome::paintEvent(QPaintEvent *event) {
  ...
  p.setOpacity(1.0);
  p.drawImage(65, 150, andarna_img);
}
