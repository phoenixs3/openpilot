...
EVENTS: Dict[int, Dict[str, Union[Alert, Callable[[Any, messaging.SubMaster, bool], Alert]]]] = {
  ...
  EventName.gasPressed: {
    ET.PRE_ENABLE: Alert(
      "Take foot of throttle to allow openpilot control vehicle",
      "",
      AlertStatus.normal, AlertSize.small,
  ...
  EventName.wrongGear: {
    ET.SOFT_DISABLE: SoftDisableAlert("Gear not Auto"),
    ET.NO_ENTRY: NoEntryAlert("Gear not Auto"),
  },
  ...
  EventName.steerUnavailable: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("EPAS Fault"),
    ET.PERMANENT: Alert(
      "Steering ECU Too Hot, wait to cool",
      "",
      AlertStatus.normal, AlertSize.small,
      Priority.LOWER, VisualAlert.none, AudibleAlert.none, 0., 0., .2),
    ET.NO_ENTRY: NoEntryAlert("EPAS Fault"),
  },
  ...
  EventName.reverseGear: {
    ET.PERMANENT: Alert(
      ...
      Priority.LOWEST, VisualAlert.none, AudibleAlert.none, 0., 0., .2, creation_delay=0.1),
